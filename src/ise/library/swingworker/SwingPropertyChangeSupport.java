...
package ise.library.swingworker;
...
public final class SwingPropertyChangeSupport extends PropertyChangeSupport {
    ...
    public void firePropertyChange(final PropertyChangeEvent evt) {
        if (evt == null) {
            // danson, I don't see any reason to throw NPE, just return and
            // be done with it.
     ...
     * @since 1.6
     */
    public /*final*/ boolean isNotifyOnEDT() {  // danson, 'final' is unnecessary
        return notifyOnEDT;
    }
